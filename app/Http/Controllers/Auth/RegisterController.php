...
class RegisterController extends Controller
{
    ...
    {
        // 1. Validasi Input (Hanya memvalidasi data dasar form registrasi depan)
        $request->validate([
        ...
        // 3. Simpan data ke dalam Laravel Session untuk diteruskan ke halaman Verifikasi
    ...
    public function verifyOtp(Request $request)
    {
        ...
        try {
            ...
            // B. Insert Petanis table (Mengosongkan profil awal agar bisa diisi mandiri oleh petani di menu profil)
            Petani::create([
                'user_id'      => $user->id,
